...
test-sketches dataset='census13' version='original' workload='base' num_bins='30000' train_version='original' seed='123':
    poetry run python -m lecarb test -s{{seed}} -d{{dataset}} -v{{version}} -w{{workload}} -esketches --params \
        "{'version': '{{train_version}}', 'num_bins': {{num_bins}}}"
